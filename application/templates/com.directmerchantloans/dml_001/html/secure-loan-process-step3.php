    ...
    <form id="rbm_bizdebt_form" action="@@action@@" method="post">
        ...
        <div id="rbm_bizdebt_content">
            ...
            <div class="section">
                ...
                <select name="rbm_bizdebt_credit_score" id="rbm_bizdebt_credit_score" class="full">
            ...
            <span class="warning">
                Business and Personal Credit Credit Scores are Vital. More than  ever before lenders are 
                placing emphasis on credit scores from Experian, Dun &amp; Bradstreet, and Equifax.
            </span>
            ...
            <div class="section">
                <label class="full">
                    <span class="star">*</span>
                     I would like a FREE credit improvement consultation to legally raise my credit scores, which may help me lock in better rates.
                </label>
                <select name="rbm_bizdebt_credit_consultation" class="full" id="rbm_bizdebt_credit_consultation">
            ...
            <div class="section">
                <label class="full" for="rbm_bizdebt_credit_imporvement">
                    <span class="star">*</span>
                    Please have a credit improvement specialist contact me via phone or email regarding my consultation.
                </label>
                
                <select name="rbm_bizdebt_credit_imporvement" class="full" id="rbm_bizdebt_credit_imporvement">
            ...
            <div class="section">
                <label for="rbm_bizdebt_terms" class="privacy_text">I have read and agree to the <a href="javascript:void(0);" data-target="privacy" class="rbm_bizdebt_overlay_open">privacy policy</a> and the <a href="javascript:void(0);" data-target="conditions" class="rbm_bizdebt_overlay_open">terms &amp; conditions</a>
                </label>
                <input type="checkbox" name="rbm_bizdebt_terms" id="rbm_bizdebt_terms" />
            </div>
        ...
        <!-- Overlay for terms/conditions and privacy policies start here -->
        
         <div id="rbm_bizdebt_privacy" class="rbm_bizdebt_overlay">
            <div id="rbm_bizdebt_privacy_content" class="rbm_bizdebt_overlay_content">
                <div class="rbm_bizdebt_overlay_txt">
                ...
                <div class="rbm_bizdebt_overlay_close" data-target="privacy"> </div>
            </div>
        </div>
        <div id="rbm_bizdebt_conditions" class="rbm_bizdebt_overlay">
            <div id="rbm_bizdebt_conditions_content" class="rbm_bizdebt_overlay_content">
                <div class="rbm_bizdebt_overlay_txt">
                    <h1>TERMS OF USE</h1>
                    <p>
                ...
                <div class="rbm_bizdebt_overlay_close" data-target="conditions"> </div>
            </div>
        </div>
        
        <!-- Overlay for terms/conditions and privacy policies  end  here -->
        
        <div id="rbm_bizdebt_footer">
            <a href="@@prev@@" id="rbm_bizdebt_back_btn" >BACK</a>
            <input type="submit" id="rbm_bizdebt_next_btn" value="NEXT »"/>
        </div>
    </form>
</div>
