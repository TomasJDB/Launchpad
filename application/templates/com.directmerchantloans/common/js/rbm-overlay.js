 ...
 * rbm_bizdebt_overlay_open, and must have a data-target attribute set to the
 * tail of the slug for the element to open. For example, data-target="privacy"
 * will open rbm_bizdebt_overlay_privacy. 
 * 
 * The close switch must have the class
 * rbm_bizdebt_overlay_close and have the data-target set to tail of the slug 
 * for the element to open. For example, data-target="privacy" will close 
 * rbm_bizdebt_overlay_privacy.
 * 
...
(function( $ ){
  ...
  var methods = {
    ...
    init : function( options ) {
      ...
      $('.rbm_bizdebt_overlay_close').each(function(){
        // Get a reference to the element
        var el = $(this);
        // Get the name of the target element
        var targetId = el.attr('data-target');
    ...
    show : function(event) {
      ...
      var el = $(this);
      var content= el.find('.rbm_bizdebt_overlay_content:first-child');
