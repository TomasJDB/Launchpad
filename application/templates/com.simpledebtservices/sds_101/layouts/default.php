...
<html>
    <head>
        ...
        <title>SimpleDebtServices.com</title>
        <meta name="description" content="consolidated_final_home" />
        <meta name="keywords" content="consolidated_final_home" />
        <script type="text/javascript" src="/sds_101/js/modernizr-1.7.min.js"> </script>
        <link rel="stylesheet" type="text/css" media="screen,projection" href="/sds_101/css/style.css" />
        <!-- <link rel="stylesheet" type="text/css" media="screen,projection" href="/sds_101/css/jquery-ui.css" /> -->
        <link rel="icon" type="image/ico" href="/sds_101/img/favicon_16x16.ico" />


        <!--<script src="//ajax.googleapis.com/ajax/libs/jquery/1.7.2/jquery.min.js" type="text/javascript"> </script>-->

        <script src="/sds_101/js/jquery.js" type="text/javascript"> </script> 
        <script src="/sds_101/js/jquery-migrate.js"> </script>
        <script src="/sds_101/js/jquery-ui.js" type="text/javascript"> </script>
        <script src="/sds_101/js/main.js" type="text/javascript"> </script>

<!--  <script src="//ajax.googleapis.com/ajax/libs/jqueryui/1.8.18/jquery-ui.min.js" type="text/javascript"> </script> -->
        <!--[if lte IE 6]>  
            <script type="text/javascript" src="/sds_101/js/ie6PngFix.js" ></script>
            <link rel="stylesheet" type="text/css" media="screen,projection" href="/sds_101/css/ie.css" />
        <![endif]-->

    </head>
    <body>
        <div id="wrapper"><!--start wrapper-->
            <div id="top_section"><p>For Immediate Debt Assistance: <strong>1-(866) 866-6153</strong></p></div>
            <div id="gray_bg"> </div>
            <div id="ai_header">
                <div class="logo"><a href="/"><img src="/sds_101/img/consolidated.png" alt="consolidated" /></a></div>
                <div class="header_rgt">
                    <a href="#"><img src="/sds_101/img/secure.png" alt="" /></a>
                    <a href="#"><img src="/sds_101/img/godaddy_site_seal.gif" alt="" /></a>
                    <a href="#"><img src="/sds_101/img/privacy.gif" alt="" /></a>
                </div>
            </div>
            <div id="top_content"><!--start top_content-->
                <div id="top_inner"><!--start top_inner-->
                    <div id="top_content_btm"><div id="top_content_bg">
                            <div id="top_two_col">
                                <div id="top_lftcol"><!--start top_lftcol-->
                                    <div id="lftcol_inner"><!--start lftcol_inner-->
                                        <h2>Consolidate  your Bills </h2>
                                        <h3>Into <em>One</em> Easy Payment!</h3>
                                        <div id="rebuild_cont_area">
                                            <ul>
                                                <li><span>Rebuild <small>your credit rating</small></span></li>
                                                <li><span>Reduce <small>your Payments</small></span></li>
                                                <li class="bg_none"><span>Get out <small>of Debt Fast!</small></span></li>
                                            </ul>

                                        </div>

                                    </div><!--//end #lftcol_inner-->
                                    <div id="clear_back">
                                        Paying off debt doesn't have to be hard, in just a few steps <br />
                                        we can show you how simple reducing your debt really is.
                                    </div>
                                </div><!--//end #top_lftcol-->
                    ...
                    <div id="feature_area"><!--start feature_area-->
                        <div class="feature_widget"><!--start feature_widget-->
                            <img src="/sds_101/img/pic_feature1.png" alt="" />
                            <div class="feature_rgt">
                                <strong>1</strong>
                                <div class="feature_info">
                                    <h3>Start Now</h3>
                                    <p>Apply online with our 
                                        simple 1 step application.</p>
                                </div>
                            </div>
                        </div><!--//end .feature_widget-->
                        <div class="feature_widget mid_feature"><!--start feature_widget-->
                            <img src="/sds_101/img/pic_feature2.png" alt="" />
                            <div class="feature_rgt">
                                <strong>2</strong>
                                <div class="feature_info">
                                    <h3>Speak With The Expert</h3>
                                    <p>Talk with the debt specialist
                                        and review your options for free.</p>
                                </div>
                            </div>
                        </div><!--//end .feature_widget-->
                        <div class="feature_widget thrd_feature"><!--start feature_widget-->
                            <img src="/sds_101/img/pic_feature3.png" alt="" />
                            <div class="feature_rgt">
                                <strong>3</strong>
                                <div class="feature_info">
                                    <h3>Start Saving</h3>
                                    <p>Immediately start saving 
                                        by reducing your payments.</p>
                                </div>
                            </div>
                        </div><!--//end .feature_widget-->
            ...
            <div id="btm_content"><!--start btm_content-->
                <div id="main_content">

                    <h1 class="lower_title">
                        We Service: Credit Cards, Personal Loans, Student Loans,
                        Department Store Cards, Gas Cards, Utility Bills, Phone
                        Bills, Medical Bills
                    </h1>

                </div><!--//end #main_content-->
                <div class="pre-footer">
                    <h2>Immediate Debt Assistance: 1-(866) 866-6153</h2>
                    <h4>©2013 <a href="#">SimpleDebtServices.com</a> All rights reserved. <a href="javascript:void(0);" data-target="privacy" class="rbm_consumerdebt_overlay_open">privacy policy</a></h4>
                </div>
                <div class="disclaimer_footer">
                    <div class="disclaimer_wrapper">
                        <p>
                            *The goal of this website and the services offered 
                            is to facilitate debt relief the smart way by
                            matching people with licensed, certified debt 
                            providers in just a few easy steps. The operator 
                            of this website is in no way a debt management 
                            company. We do not guarantee your debts will be 
                            resolved by our preferred partners for a specific
                            amount, percentage, or within a specific period of 
                            time. We do not assume your debts, or provide tax,
                            bankruptcy, accounting, or legal advice. You will be
                            contacted by phone to discuss the debt relief 
                            options that are best suited for your individual 
                            needs, and there is no obligation or fee for this 
                            service, and is strictly for consultation purposes 
                            only.
                        </p> 
                    </div>
                </div>
        ...
        <!-- overlay start -->
        <div id="rbm_consumerdebt_privacy" class="rbm_consumerdebt_overlay">
            <div id="rbm_consumerdebt_privacy_content" class="rbm_consumerdebt_overlay_content">
                <div class="rbm_consumerdebt_overlay_txt">
                ...
                <div class="rbm_consumerdebt_overlay_close" data-target="privacy"> </div>
            </div>
        </div>
        <!-- overlay end -->
        <script src="/sds_101/js/rbm-overlay.js" type="text/javascript"> </script>
    </body>
</html>   