...
DD_belatedPNG.fix('#top_content_btm,#top_content_bg,img,.btn_submit input,.secure h3,.white_box_top,.white_box_btm,.white_box_bg,.widget_top,.feature_widget,.widget_bg,.widget_btm');
