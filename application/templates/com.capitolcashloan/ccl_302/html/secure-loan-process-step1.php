<div id="rbm_personalloan">
    <form id="rbm_personalloan_form" action="/@@template@@/@@action@@" method="post">
        ...
        <div id="mid_form" class="relevant">
            ...
            <div id="rbm_personalloan_bubbles">
                ...
                <div class="bublewrapper black">
                    ...
                    <img src="/ccl_302/img/arrow2.png" id="arrow_down" alt="arrow" />
                    </label>
                    <br />
                    <br />
                    <div id="rbm_personalloan_loan_ammounts" class="rbm_personalloan_bubbles" name="rbm_personalloan_loan_ammount_wrapper">

                        <button type="button" name="bubble_button_100" class="rbm_personalloan_bubble_option bubble_button_100 sprite_button_1000" value="1000"> </button>
                        <button type="button" name="bubble_button_200" class="rbm_personalloan_bubble_option bubble_button_200 sprite_button_2000" value="2000"> </button>
                        <button type="button" name="bubble_button_300" class="rbm_personalloan_bubble_option bubble_button_300 sprite_button_3000" value="3000"> </button>
                        <button type="button" name="bubble_button_400" class="rbm_personalloan_bubble_option bubble_button_400 sprite_button_4000" value="4000"> </button>
                        <button type="button" name="bubble_button_500" class="rbm_personalloan_bubble_option bubble_button_500 sprite_button_5000" value="5000"> </button> 
                        <button type="button" name="bubble_button_600" class="rbm_personalloan_bubble_option bubble_button_600 sprite_button_6000" value="6000"> </button> 
                        <button type="button" name="bubble_button_700" class="rbm_personalloan_bubble_option bubble_button_700 sprite_button_7000" value="7000"> </button>
                        <button type="button" name="bubble_button_750" class="rbm_personalloan_bubble_option bubble_button_750 sprite_button_7500" value="7500"> </button>
        ...
        <div id="rbm_personalloan_footer">
            <img src="/ccl_302/img/privacy_shield.png" id="rbm_personalloan_privacy_shiled" alt="privacy" />
