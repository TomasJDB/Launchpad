<div id="rbm_personalloan">
    <form id="rbm_personalloan_form" action="/@@template@@/@@action@@" method="post">
        <div id="rbm_personalloan_header">
            <h1>Just complete the information below to request $100 - $2,500!</h1>
        </div>
        ...
        <div id="rbm_personalloan_content">
            ...
            <div class="row">
                ...
                <br />
                <div class="section">
                    <label for="rbm_personalloan_loan_amount" class="blue_label">Amount you wish to borrow:</label>
                    <select name="rbm_personalloan_loan_amount" id="rbm_personalloan_loan_amount" class="half">
            ...
            <div class="row">
                ...
                <h1>Personal Info</h1>
                <span class="label">
                    Personal questions are asked in order to ensure that you are, in fact the person requesting the loan.
                </span>
                ...
                <div class="section_container">
                    ...
                    <div class="section">
                        <label for="rbm_personalloan_title">Title</label>
                    ...
                    <div class="section end">
                        <label for="rbm_personalloan_birthdate" class="full date">Date of Birth<br /><span class="subheading">(mm/dd/yyyy)</span></label>
                    ...
                    <div class="section">
                        <label for="rbm_personalloan_residence_date" class="full">Time at Residence</label>
                    ...
                    <div class="section end">
                        <label for="rbm_personalloan_min_amount" class="full">Minimum Amount</label>
            ...
            <div class="row">
                ...
                <span class="label">Lenders use this information to verify your employment, if you are not employed
                    but have a regular income you can still qualify for a loan.
                </span>
                ...
                <div class="section">
                    <label for="rbm_personalloan_employ_date" class="full">When did you start your present job?</label>
                    <select name="rbm_personalloan_employ_date_month" id="rbm_personalloan_employ_date_month" class="date_drop">
                        <option value="">Month</option>
                        <option value="01">01</option>
                        <option value="02">02</option>
                        <option value="03">03</option>
                    ...
                    <span class="lg_gray">/</span>
                    <select name="rbm_personalloan_employ_date_year" id="rbm_personalloan_employ_date_year" class="date_drop" data-validate="true">
                        <option value="">Year</option>
                        <option value="2013">2013</option>
                        <option value="2012">2012</option>
                        <option value="2011">2011</option>
            ...
            <div class="row">
                ...
                <h1>Bank Info (Don't have a bank Account? <a href="@@rush_link@@">Click Here</a>)</h1>
                <span class="label">
                    Lenders require your bank information, in order to know and 
                    verify where to deposit the money once the loan is approved
                </span>
                ...
                <div class="section">
                    <label for="rbm_personalloan_bank_routing_number" class="full">
                        Routing Number <br /><span class="subheading">(9 digits)</span><br />
            ...
            <div class="row">
                <h1>Final Identity Verification:</h1>
                <span class="label">
                    In order to protect you from fraudulent use of your name and
                    information, we require your social security number and 
                    driver's license to verify you are the person requesting 
                    this loan.
                </span>
                <br />
            ...
            <div class="gray_area">
                ...
                <div class="div-centerd vertical_middle">
                    <div class="section end">
                        <div class="lock">
        ...
        <div id="rbm_personalloan_footer">
            <div id="rbm_personalloan_btn_filler"> </div>
            <input type="submit" id="rbm_personalloan_submit_btn" class="submit_now" value=""/>
        </div>
    </form>
