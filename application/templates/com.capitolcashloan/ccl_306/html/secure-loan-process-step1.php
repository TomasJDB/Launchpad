<div id="rbm_personalloan">
    <form id="rbm_personalloan_form" action="/@@template@@/@@action@@" method="post">
            ...
            <tbody>
                <tr>
                    <td class=" vertical_middle">
                        ...
                        <span class="small_big light gray">Select loan amount below</span>
                    </td>
        ...
        <div id="rbm_personalloan_content">
            ...
            <div class="section">
                <label for="rbm_personalloan_loan_amount" class="half">How much would you like to borrow?</label>
        ...
        <div id="rbm_personalloan_footer">
            <img src="/ccl_306/img/privacy_shield.png" alt="Secure Connection" id="privacy_shiled" />
            <div id="rbm_personalloan_btn_filler"> 
