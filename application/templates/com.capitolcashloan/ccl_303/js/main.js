   ...
   */
    $(document).ready(function(){
        ...
        var settings = {
            ...
            "$100" : "-5px -78px",//bg position if val is 200
            "$200" : "-5px -156px", //bg position if val is 300
            "$300" : "-5px -234px", //bg position if val is 300
            "$400" : "-5px -311px", //bg position if val is 300
            "$500" : "-5px -389px", //bg position if val is 300
            "$600" : "-5px -467px", //bg position if val is 300
            "$700" : "-5px -545px", //bg position if val is 300
            "$800" : "-5px -622px", //bg position if val is 300
            "$900" : "-5px -700px", //bg position if val is 300
            "$1,000" : "-5px -788px" //bg position if val is 300
        }
        }
