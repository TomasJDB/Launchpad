<div id="rbm_personalloan">
    <form id="rbm_personalloan_form" action="/@@template@@/@@action@@" method="post">
        ...
        <div id="mid_form" class="relevant">

            <div id="rbm_personalloan_bubbles">

                <div class="bublewrapper black">

                    <label for="rbm_personalloan_loan_amount" class="full">Select Your Loan Amount
                    <img src="/ccl_304/img/arrow2.png" id="arrow_down" alt="arrow" />
                    </label>
                    <br />
                    <br />
                    <div id="rbm_personalloan_loan_ammounts" class="rbm_personalloan_bubbles" name="rbm_personalloan_loan_ammount_wrapper">

                        <button type="button" name="bubble_button_100" class="rbm_personalloan_bubble_option bubble_button_100" value="100"> </button>
                        <button type="button" name="bubble_button_200" class="rbm_personalloan_bubble_option bubble_button_200" value="200"> </button>
                        <button type="button" name="bubble_button_300" class="rbm_personalloan_bubble_option bubble_button_300" value="300"> </button>
                        <button type="button" name="bubble_button_400" class="rbm_personalloan_bubble_option bubble_button_400" value="400"> </button>
                        <button type="button" name="bubble_button_500" class="rbm_personalloan_bubble_option bubble_button_500" value="500"> </button>
                        <button type="button" name="bubble_button_600" class="rbm_personalloan_bubble_option bubble_button_600" value="600"> </button>
                        <button type="button" name="bubble_button_700" class="rbm_personalloan_bubble_option bubble_button_700" value="700"> </button>
                        <button type="button" name="bubble_button_800" class="rbm_personalloan_bubble_option bubble_button_800" value="800"> </button>
                        <button type="button" name="bubble_button_900" class="rbm_personalloan_bubble_option bubble_button_900" value="900"> </button>
                        <button type="button" name="bubble_button_1000" class="rbm_personalloan_bubble_option bubble_button_1000" value="1000"> </button>

                        <input name="rbm_personalloan_loan_amount" id="rbm_personalloan_loan_amount" class="bubble_value" type="hidden" /> 
                    </div>
        ...
        <div id="rbm_personalloan_content">
            <div class="section">
                <label for="rbm_personalloan_zip" class="half">Zip Code</label>
                <input type="text" name="rbm_personalloan_zip" id="rbm_personalloan_zip" class="half" maxlength="5"/>
            </div>
            <div class="section">
                <label for="rbm_personalloan_loan_type" class="half">Reason for Loan</label>
            ...
            <div class="section">
                <label for="rbm_personalloan_bankruptcy" class="half">Do you have a prior bankruptcy?</label>
            ...
            <div class="section">
                <label for="rbm_personalloan_min_amount" class="full">To INCREASE your APPROVAL chances, please select the minimum amount you would accept</label>
            ...
            <div class="section">
                <label for="rbm_personalloan_terms" class="privacy_text">I have read and agree to the <a href="javascript:void(0);" data-target="privacy" class="rbm_personalloan_overlay_open">privacy policy</a> and the <a href="javascript:void(0);" data-target="conditions" class="rbm_personalloan_overlay_open">terms &amp; conditions</a>
                </label>
                <input type="checkbox" name="rbm_personalloan_terms" id="rbm_personalloan_terms" />
            </div>
        </div>
        <div id="rbm_personalloan_privacy" class="rbm_personalloan_overlay">
            <div id="rbm_personalloan_privacy_content" class="rbm_personalloan_overlay_content">
                <div class="rbm_personalloan_overlay_txt">
                    <h1>REAL BRIGHT MEDIA INC PRIVACY POLICY</h1>
                    <p>
                        Real Bright Media, Inc. (hereinafter referred to as "Company" "we," "us," or "our") takes you privacy seriously.  We are committed to advising you of the right to your privacy and recommend that you review the Federal Government's practical tips on guarding your privacy at http://onguardonline.gov/. This Privacy Policy covers the online data collection and usage policies and practices that apply to the "Website Name" (referred to as "Website"). 
                    ...
                    <p>
                        Providing Information about our Services and Products:  We may use the information that you provide to keep you up-to-date on our products and services.  We will do this through email marketing.  If you no longer wish to receive our updates, please email us at optout@rbmleads.com.
                    </p>
                    ...
                    <p>
                        California residents who are users of this site are entitled to know that they may file complaints and grievances with the California Department of Consumer Affairs by emailing dca@dca.ca.gov, calling 800-952-5210, or writing to CDCA, 400 R Street, Suite 1080, Sacramento, CA 95814.    You may also request further information about our compliance with this law by e-mailing privacy@rbmleads.com.
                    </p>
                    <h2>CONTACT INFORMATION</h2>
                    <p>
                        If you have any questions regarding this Privacy Policy, you may email privacy@rbmleads.com or write to "Address".  if you would like to opt-out or remove your registration information from our database, please email optout@rbmleads.com.
                    </p>
                    <br/>
                    <br/>
                    <br/>
                </div>
                <div class="rbm_personalloan_overlay_close" data-target="privacy"> </div>
            </div>
        </div>
        <div id="rbm_personalloan_conditions" class="rbm_personalloan_overlay">
            <div id="rbm_personalloan_conditions_content" class="rbm_personalloan_overlay_content">
                <div class="rbm_personalloan_overlay_txt">
                    <h1>TERMS OF USE</h1>
                    <p>
                        Real Bright Media, Inc. ("Company" "we," "us," or "our") welcome you.  Before you begin to use the @@host@@ ("Website"), we ask that you take the time to review these Terms of Use ("Agreement") which is a legal agreement.  The Agreement describes the Terms of Use which govern your use of the Website and the products and services provided through or in connection with the Website (collectively, "Service").  These terms may be updated and changed by us from time to time by posting the same on our Website without further notice to you.  Continued use of our Services after posting constitutes an acceptance by you of the changes or modification. You must agree with all of the Terms of Use contained in this Agreement and the posted Privacy Policy then in effect ("Privacy Policy"), which is incorporated by reference, before you use the Service.  If you do not agree to be bound by these Terms of Use and Privacy Policy of this Agreement, you may not use or access the Service.
                    </p>
                    <h2>USER AGREEMENT</h2>
                    <p>
                        By using this Website, you agree to be bound by and to comply with these Terms of Use and the posted Privacy Policy which is incorporated herein as though fully set forth herein.  Upon entering the requested information, our technology will forward your information to one of our participating lenders or to an aggregate of lenders who may contact you to engage in a loan transaction if you are accepted by them.  This may be done automatically and a new window may appear or the lender may contact you directly by telephone, email or mail as set forth below. 
                    </p>
                    <p>
                        WE ARE NOT RESPONSIBLE FOR ANY ACTIONS AFTER YOU HAVE LEFT THIS WEBSITE.  UPON ENTRY INTO A LENDER'S, AGGREGATOR'S OR ADVERTISER'S WEBSITE LINKED TO THIS WEBSTIE, YOU SHOULD CAREFULLY REVIEW THE PRIVACY POLICY AND TERMS OF USE OF THAT WEBSITE BEFORE ENTERING ANY PERSONAL INFORMATION AS THOSE POLICES AND TERMS WILL DIFFER FROM THESE.
                    </p>
                    <p>
                        In order to provide you the services you have requested, you expressly give us permission to provide any information collected on this Website to third parties as described in the posted Privacy Policy.  As such, you expressly give your permission for such third parties to contact you by mail, email, text messaging or telephone.  By registering and using this Website, you agree that such acts constitute a purchase, an inquiry and/or an application for purposes of the Amended Telemarketing Sales Rule, 16 CFR §310 et seq. (the "ATSR").  Notwithstanding that your telephone number may be listed on the Federal Trade Commission's Do-Not-Call List (or a state do-not-call) list, you have authorized us to contact you via telemarketing in accordance with the ATSR.  Moreover, by registering with, or requesting information from, a third-party advertiser at or through the Website or other advertisement media made available by us (e.g., email marketing), you agree that such action shall constitute a purchase, an inquiry and/or an application with the respective third-party advertiser for purposes of the ATSR and you may be contacted via email, direct mail and/or telemarketing by such third-party advertiser in accordance with the ATSR.  If, at any time, you do not wish to be bound by these conditions or you are unsatisfied with the Website, its content or other legal notices, you agree that your sole and exclusive remedy is to discontinue using this Website.
                    </p>
                    <p>
                        You further represent and warrant that: (i) You are at least 18 years of age, are a U.S. citizen and possess the legal authority to enter into an agreement and to use the Website in accordance with these Terms of Use; (ii) All information supplied by you is true and accurate (without limitation of the foregoing, the provision of any speculative, incorrect, misleading, false or fraudulent information is prohibited); (iii) You understand and agree that Company may share personally identifiable information and other information provided by, and aggregated information about you and other users with its vendors, sponsors, advertisers, service providers and marketers, lookup and reference services, other unaffiliated third parties, and other entities that Company believes are able to provide its Website users with offers and opportunities, as more fully described in the Company's posted Privacy Policy [LINK]; (iv) You understand that abuse of this Website may result in your being denied access to such Website, as determined by Company in its sole discretion; (v) You understand and agree that, in addition to these Terms of Use, your use of this Website will be governed by the official rules applicable to the promotion or offer, if any; (vi) You understand and agree that Company controls only the landing page and intake forms on this Website.  Upon entry of the requested information, a participating lender will contact you directly to provide you with information regarding its loan products.  Company shall not be responsible for any lender or aggregator contact with you or any subsequent agreement you may enter into with such lender or aggregator; and (vii) Your use of the Services on this Website is subject to all applicable federal, state and local laws and regulations; (viii) You also give us permission to send you periodic updates of services and products which may be of interest to you through email, mail, or telemarketing.
                    </p>
                    <h2>SERVICES</h2>
                    <p>
                        The Website is an online network marketplace.  You understand and agree that if you submit a request through the Website, we will share your personal information (such as your full name, address, telephone number, and financial information) with lenders or aggregators in our network in order to process and fulfill your request.  You understand and agree that we do not broker loans, make loans directly, undertake credit analysis or make credit decisions in connection with the Service and that we are not a party to any agreement that you may make with any lender with whom you may obtain a loan.  The lender with whom you make a loan is solely responsible for its provision of services to you.  You further acknowledge and agree that we are not acting as your agent or broker and are not recommending any particular loan product or lender to you.  Any compensation we may receive from the lender or aggregator is paid for advertising services we provided to them.  We do not charge you a fee to use the Website. You understand that the requirements for a particular loan product are determined by the individual lenders and we do not endorse, warrant, or guarantee the products or services of any lender.  Nothing contained in this Agreement shall constitute an offer or promise for a loan commitment or interest rate lock-in agreement.  You agree that we shall not be liable for any damages or costs of any type which arise out of or in connection with your use of the lender's services.
                    </p>
                    <p>
                        You also give us permission to send you periodic updates regarding services and products which may be of interest to you.  Please note that information we provide you either on the website or by email may not be used as the sole basis for your loan decision and may not meet your particular needs.  Please seek the advice of an appropriate professional for an assessment of the loan information provided by the lender.
                    </p>
                    <h2>CHANGES TO TERMS OF USE AND POLICIES</h2>
                    <p>
                        Company reserves the right, in our sole discretion, to change, modify or otherwise alter these Terms of Use and the posted Privacy Policy which appear on this Website at any time and for any reason.  Such a change, modification or alteration is effective upon its posting to the Website without further notice to you.  It is your responsibility to periodically review the Terms of Use and the posted Privacy Policy for changes.  Your continued use of the Website following the posting of changes and/or modifications will constitute your acceptance of the revisions and the reasonableness of notice of changes. 
                    </p>
                    <h2>REJECTION, TERMINATION AND CANCELLATION</h2>
                    <p>
                        Company or its participating lenders or aggregators may reject any registration or subsequent application from any person with or without cause at their sole discretion.  Your status as a registered user creates only a customer relationship with Company and does not create an employment relationship, an independent contractor relationship, an agency relationship, or any other relationship.  You may cancel your request at anytime by sending an e-mail to optout@rbmleads.com.  
                    </p>
                    <h2>PROHIBITED USER CONDUCT</h2>
                    <p>
                        A.  You are prohibited from any conduct that the Company believes, in its sole discretion, restricts or inhibits any other user from using or enjoying the Website or any linked Website.  You are prohibited from accessing or attempting to access private areas of the Website or any other user's information.  You are prohibited from impersonating any person or entity or otherwise falsely stating or misrepresenting your affiliation with a person or entity.
                        <br />
                        B.  You are prohibited from using any data, content or other information provided or used on the Website in any manner which will infringe or facilitate infringement on any copyright, patent, trademark, trade secret, or other proprietary, publicity or privacy rights of any person or entity, including third-parties.  You are prohibited from using any data, content or information which contains or promotes any viruses, Trojan horses, worms, time bombs or other computer programming or code that is designed or intended to damage, destroy, intercept, download, interfere, manipulate, or otherwise interrupt or expropriate the Website, data, personal information, software, equipment, servers or content or facilitate or promote hacking or similar conduct.  You are prohibited from harvesting, sweeping or using any other means to collect information about users of the Website.  You may not use automated means, including spiders, robots, bots, scripts, crawlers, or the like, in connection with any activity on the Website.  You are prohibited from reselling, assigning, sublicensing, otherwise transferring, or delegating your rights or obligations under these Terms of Use without the prior express written authorization of Company.  You may not modify, publish, transmit, transfer or sell, reproduce, create derivative works from, distribute, perform, link, display or in any other way exploit any Website content or, except as otherwise expressly permitted on the Website, use any information you may obtain from the Website (including without limitation, user information) to send any other person unsolicited messages, commercial or otherwise, by electronic, telephonic, postal or other means. 
                    </p>
                    <h2>MARKETING MATERIALS</h2>
                    <p>
                        By signing up at the Website, you consent to receive promotions or newsletters from Company, our affiliates and/or third-party marketers.  If you do not wish to receive these emails, you may request to be removed by using the opt-out mechanism listed in the email messages you receive.  To opt-out of email promotions from Company alone, you may simply use our convenient Unsubscribe Email at the bottom of the first page of the Website.  Please note that exercising an opt-out mechanism only applies to the company with which you exercised that right.
                    </p>
                    <h2>THIRD PARTY CONTENT/PROMOTIONS, THIRD PARTY PRODUCTS, AND THIRD PARTY WEBSITE ACTIVITIES</h2>
                    <p>
                        The Website may display and make available content, promotions, advertisements, and offers provided by third parties ("Third Party Promotions"), as well as goods and services offered by third parties ("Third Party Products").  You understand and agree that Company shall not be responsible and shall have no liability for any Third Party Promotion or Third Party Product or for your activities on any third party Websites for whom Company displays offers ("Third Party Website Activity"), and that you participate in or choose to click on a Third Party Promotion, purchase and/or use a Third Party Product, or participate in a Third Party Website Activity solely at your own risk.  You agree that your sole remedy in connection with any Third Party Promotion, Third Party Product or Third Party Website Activity will be with the applicable third party offering the Third Party Promotion, Third Party Product or Third Party Website Activity and that you shall have no remedy against Company arising from your use of, participation in, or inability to use or participate in, any Third Party Promotion, Third Party Product or Third Party Website Activity. 
                    </p>
                    <h2>RELATIONSHIP WITH MARKETING ADVERTISERS</h2>
                    <p>
                        The Website is not affiliated with any of the products advertised on the site.  Trademarks, service marks, logos, and/or domain names are the property of their respective owners, who have no association with or make any endorsement of the products or services provided by the Website.  Furthermore, entities whose advertisements appear on the Website are independent third parties and Company does not act as a principal, agent or broker with respect to any advertiser. We have a financial relationship with the marketing advertisers, participating lenders and aggregators with whom we share your information. 
                    </p>
                    <h2>LINKED WEBSITES</h2>
                    <p>
                        You may be able to link to third parties' Websites ("Linked Websites") from the Website.  Linked Websites are not, however, reviewed, controlled or examined by Company in any way and Company is not responsible for the content, availability, advertising, products or other materials of any such Linked Websites or any additional links contained therein.  Except as otherwise noted on the Website, these links do not imply Company's endorsement of or association with the Linked Websites.  In no event shall Company be liable, directly or indirectly, to anyone for any loss or damage arising from or occasioned by the creation or use of links to the Linked Websites, the Linked Websites themselves, your participation in activities on such Linked Websites, or the information, material, products or services accessed through these Linked Websites.  You should direct any concerns to that Website's administrator or webmaster. Company reserves the exclusive right, at its sole discretion, to add, change, decline or remove any feature or link to any of the Linked Websites from the Website and/or introduce different features or links without notice. 
                    </p>
                    <h2>INTELLECTUAL PROPERTY RIGHTS</h2>
                    <p>
                        The Website contains intellectual property owned by Company and other parties.  As between Company and you, Company is the sole owner of the Website and all materials on or available through the Website, including without limitation, all applicable U.S. and non-U.S. copyrights, patents, trademarks, and trade secrets, and other intellectual property rights thereto (collectively, the "Website Content").  Except as otherwise specifically provided in these Terms of Use, you may not download or save a copy of the Website Content or any portion thereof for any purpose.  You may, however, print a copy of individual screens appearing as part of the Website Content solely for your personal, non-commercial use or records, provided that any Company or other marks, logos or other legends that appear on the copied screens remain on, and are not removed from the printed or stored images of such screens. 
                    </p>
                    <p>
                    ...
                    <h2>MONITORING WEBSITE USAGE</h2>
                    <p>
                    ...
                    <h2>INDEMNITY</h2>
                    <p>
                        You agree to defend, indemnify and hold Company, its parents, subsidiaries, partners, agents, affiliates, licensors, advertisers, successors and assigns and their respective officers, directors, employees and shareholders harmless from any and all claims, liabilities, costs and expenses, including reasonable attorneys' fees, arising in any way from, in connection with or as a result of your use or inability to use the Website and or Website Content, any information provided to you by the Website, or any violation of these Terms of Use by you. 
                    </p>
                    <p>
                    ...
                    <p>
                        This Agreement constitutes the entire agreement between you and Company and governs your use of the Website and Service and supersedes any prior agreements.  You also may be subject to additional Terms of Use that may apply when you use or purchase other Company services, affiliated services, third party content or third party software.
                    </p>
                    <h2>STATUTE OF LIMITATIONS</h2>
                    <p>
                        YOU AGREE THAT REGARDLESS OF ANY STATUTE OR LAW TO THE CONTRARY, ANY CLAIM OR CAUSE OF ACTION ARISING OUT OF RELATED TO USE OF THE SERVICE OR THE AGREEMENT MUST BE FILED WITHIN ONE (1) YEAR AFTER SUCH CLAIM OR CAUSE OF ACTION ARISES OR BE FOREVER BARRED.
                    </p>
                </div>
                <div class="rbm_personalloan_overlay_close" data-target="conditions"> </div>
            </div>
        </div>
        <div id="rbm_personalloan_footer">
            <img src="/ccl_304/img/privacy_shield.png" id="rbm_personalloan_privacy_shiled" alt="privacy" />
            <input type="submit" id="rbm_personalloan_next_btn" class="single"  value=""/>
        </div>
    </form>
</div>
