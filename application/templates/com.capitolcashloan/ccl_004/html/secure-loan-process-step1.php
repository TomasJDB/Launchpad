<div id="rbm_personalloan">
    <form id="rbm_personalloan_form" action="/@@template@@/@@action@@" method="post">
        ...
        <div id="rbm_personalloan_content">
            ...
            <div class="section">
                <label for="rbm_personalloan_terms" class="privacy_text">I certify that I am a U.S. Resident over the age of 18, I agree to the <a href="javascript:void(0);" data-target="privacy" class="rbm_personalloan_overlay_open">privacy policy</a> and the <a href="javascript:void(0);" data-target="conditions" class="rbm_personalloan_overlay_open">terms &amp; conditions</a> and that I may receive SMS.
                </label>
        ...
        <div id="rbm_personalloan_footer">
            ...
            <input type="submit" id="rbm_personalloan_next_btn" class="get_cash_fast" value=""/>
        </div>
    </form>
</div>
