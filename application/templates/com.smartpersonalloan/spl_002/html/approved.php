<div id="rbm_personalloan">
    <div id="rbm_personalloan_plain_container">
        <div class="section"><img src="/spl_002/img/approved_hdr.png" alt="" /> </div>
        <div class="section">
            <p class="color_box text-center headline">
        ...
        <div class="section">
            <p class="fine_print text-center navy"><b>
YOU ARE BEING CONNECTED TO COMPLETE YOUR LOAN            </b></p>
        ...
        <div class="section">
            <p class="fine_print text-center" style="color: #9D9D9D;">
