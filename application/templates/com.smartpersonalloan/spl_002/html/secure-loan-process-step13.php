...
<div id="rbm_personalloan">
    <form id="rbm_personalloan_form" action="/@@template@@/@@action@@" method="post">
        ...
        <div id="rbm_personalloan_header">
            ...
            <p class="progress" style="background-position: 0px -197px;"> </p>
        </div>
        <div id="rbm_personalloan_content">
            <div class="section">
                <p class="full text-center headline_shadow">
                    We are ready to submit your application in order to recieve multiple offers of cash and credit.
                </p>
            </div>
            <div class="section">
                <label for="rbm_personalloan_maiden_name" class="full">Mother's Maiden Name?</label>
                <input type="text" name="rbm_personalloan_maiden_name" id="rbm_personalloan_maiden_name" class="full" value="" />
            </div>
            <div class="section">
                <label for="rbm_personalloan_citizen" class="full">Are you a U.S. citizen?</label>
                <select name="rbm_personalloan_citizen" id="rbm_personalloan_citizen" class="full">
    ...
    <div id="rbm_personalloan_lightbox" class="rbm_personalloan_overlay">
        <div id="rbm_personalloan_lightbox_content" class="rbm_personalloan_overlay_content">
            <div class="rbm_personalloan_overlay_txt">
                ...
                <div id="lb-wr-load">
                    <img src="/spl_002/img/loading.gif" alt="" />
                </div>
                <p class="lb-txt">
