 ...
 * rbm_@@app_name@@_overlay_open, and must have a data-target attribute set to the
 * tail of the slug for the element to open. For example, data-target="privacy"
 * will open rbm_@@app_name@@_overlay_privacy. 
 * 
 * The close switch must have the class
 * rbm_@@app_name@@_overlay_close and have the data-target set to tail of the slug 
 * for the element to open. For example, data-target="privacy" will close 
 * rbm_@@app_name@@_overlay_privacy.
 * 
...
(function( $ ){
  ...
  var methods = {
    ...
    init : function( options ) {
      ...
      $('.rbm_@@app_name@@_overlay_open').each(function() {
        // Get a reference to the element
        var el = $(this);
        // Get the name of the target element
        var targetId = el.attr('data-target');
        var target = $('#rbm_@@app_name@@_'+targetId);
      ...
      $('.rbm_@@app_name@@_overlay_close').each(function(){
        // Get a reference to the element
        var el = $(this);
        // Get the name of the target element
        var targetId = el.attr('data-target');
    ...
    show : function(event) {
      ...
      var el = $(this);
      var content= el.find('.rbm_@@app_name@@_overlay_content:first-child');
