<div id="rbm_personalloan">
    <form id="rbm_personalloan_form" action="@@action@@" method="post">
        ...
        <div id="rbm_personalloan_content">
            ...
            <div class="section">
                <p class="color_box">
                    <img src="/ccl_001/img/white_warning.png" /><br />
            ...
            <div class="section">
                <label for="state" class="full">I would like a FREE credit improvement consultation to legally raise my credit scores, which may help me lock in better rates.</label>
