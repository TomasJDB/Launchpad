<div id="rbm_personalloan">
    <form id="rbm_personalloan_form" action="/@@template@@/@@action@@" method="post">
        ...
        <div id="rbm_personalloan_content">
            ...
            <div class="section">
                <label for="rbm_personalloan_bankruptcy" class="full">Do you have a prior bankruptcy?</label>
                <select name="rbm_personalloan_bankruptcy" id="rbm_personalloan_bankruptcy" class="full">
                    <option value=''>Choose</option>
