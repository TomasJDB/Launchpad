    ...
    var methods = {
        ...
        ini : function(parent, options){
            ...
            $.each(parent, function(){
                ...
                $('.rbm_personalloan_bubble_option').click(function (){
                    var el = $(this);
                    ...
                    $('#rbm_personalloan_form').trigger('auto.submit');
                });  
            })
        },
        /*
        ...
        selected : function (element, value){
            ...
            if(value.length > 0){
                ...
                var changeToSelected = $("button[value="+value+"]");
                if(methods.exists(changeToSelected) && changeToSelected.attr('type') != "hidden" ){//if such element with the value exists
                    //get the name of the element
                    var el_name = changeToSelected.attr("name");
                    //removes previus class el_name+ "selected"
                    element.find(".rbm_personalloan_bubble_option").each(function(){
