    ...
    var methods ={
        ...
        init : function (options, el) {
            ...
            var refresh = function(){
                ...
                var check_time = tm.split(":");
                if(Number(check_time[1]) <= 0){
         ...
         * 
         * @param cname String Expecting the name that the cookie should be named cookie
        ...
        convertMiliseconds : function (ms){
            ...
            mt = (mt < 1 && h == "00:") ? "" : (mt.toString().length < 2)? "0" + mt + ":" : mt + ":";
            s = (s < 1 && mt == "00") ? "00" : (s.toString().length < 2)? "0" + s  : s ;
            return h + "" + mt + "" + s;
        },
        /**
