<div id="rbm_creditscore">
    <form id="rbm_creditscore_form" action="/@@template@@/@@action@@" method="post">
        ...
        <div id="rbm_creditscore_content">
            ...
            <div class="section">
                <p class="color_box">
                    <img src="/ccs_102/img/white_warning.png" /><br />
            ...
            <div class="section">
                <label for="rbm_creditscore_creditrepair_optin" class="full">
                ...
                <select name="rbm_creditscore_creditrepair_optin" id="rbm_creditscore_creditrepair_optin" class="half">
                    <option value="">Choose</option>
            ...
            <!--
                        <div class="section rbm_creditscore_reveal" data-trigger-element="rbm_creditscore_creditrepair_optin" data-trigger-value="true">
                            <label for="rbm_creditscore_creditrepair_consent" class="full">
...
We encourage you to take time to look into this.
                            ...
                            <select name="rbm_creditscore_creditrepair_consent" id="rbm_creditscore_creditrepair_consent" class="half">
                                <option value="">Choose</option>
                                <option value="true">Yes</option>
                                <option value="false">No</option>
                            </select>
