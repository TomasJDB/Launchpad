<div id="rbm_creditscore">
    <form id="rbm_creditscore_form" action="/@@template@@/@@action@@" method="post">
        ...
        <div id="rbm_creditscore_content">
            ...
            <div class="section">
                <label for="rbm_creditscore_maiden_name" class="half">Mother's Maiden Name?</label>
                <input type="text" name="rbm_creditscore_maiden_name" id="rbm_creditscore_maiden_name" class="half" value="" />
            </div>
            <div class="section">
                <label for="rbm_creditscore_citizen" class="half">Are you a U.S. citizen?</label>
                <select name="rbm_creditscore_citizen" id="rbm_creditscore_citizen" class="half">
            ...
            <div class="section">
                <label for="rbm_creditscore_consent" class="privacy_text"><b>Yes, please present information to all lenders</b>, including short term cash loan lenders if your system is unable to match me with a prime loan provider.</label>
                <input type="checkbox" name="rbm_creditscore_consent" id="rbm_creditscore_consent"/>
            </div>
        </div>
        <div id="rbm_creditscore_footer">
            <input type="submit" id="rbm_creditscore_submit_btn" value=""/>
        </div>
    </form>
    <div id="rbm_creditscore_lightbox" class="rbm_creditscore_overlay">
        <div id="rbm_creditscore_lightbox_content" class="rbm_creditscore_overlay_content">
            <div class="rbm_creditscore_overlay_txt">
                ...
                <div id="lb-wr-load">
                    <img src="/ccs_101/img/loading.gif" alt="" />
                </div>
                <p class="lb-txt">
    ...
    <script type="text/javascript">
        // <![CDATA[
            $('#rbm_creditscore_form').submit(function(){
                // Get a reference to this
                var el = $('#rbm_creditscore_lightbox');
                var content= el.find('#rbm_creditscore_lightbox_content');
