...
<div id="rbm_personalloan">
    <form id="rbm_personalloan_form" action="/@@template@@/@@action@@" method="post">
        <div id="rbm_personalloan_header">
            ...
            <img src="/slq_001/img/locked.png" alt="locked" class="locked" align="left" /> <p class="progress" style="background-position: 0px -121px;"> </p>
            <div class="cover"> </div>
        </div>
        <div id="rbm_personalloan_content">
            ...
            <div class="section">
                <label for="rbm_personalloan_ssn_1" class="full_minus">
