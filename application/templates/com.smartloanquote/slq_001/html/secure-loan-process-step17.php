...
<div id="rbm_personalloan">
        ...
        <div id="rbm_personalloan_content">
            <div class="section">
                <p class="full center headline_shadow">
                    We are READY to submit your application in order to receive multiple offers of cash and credit.
                </p>
            </div>
            <div class="section">
                <label for="rbm_personalloan_maiden_name" class="full_plus">Mother's Maiden Name?</label>
                <input type="text" name="rbm_personalloan_maiden_name" id="rbm_personalloan_maiden_name" class="full_plus" value="" />
            </div>
            <div class="section">
    ...
    <div class="info">
        ...
        <p>In addition to verifying your identity to qualify for a loan, we will delete this information from our database once your transaction is done to ensure your privacy.</p>
    </div>
