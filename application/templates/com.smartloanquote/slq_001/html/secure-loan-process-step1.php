<div id="form-app-container" class="first_container">
    <div class="arrow"> </div>
    <div id="rbm_personalloan">
        <form id="rbm_personalloan_form" action="/@@template@@/@@action@@" method="post">
            <div id="rbm_personalloan_header" class="first_header">
                <h1 class="form-title" id="form_title">Start your 3 Minute Application!</h1>   
            </div>
            <div id="rbm_personalloan_content" class="first_page_container">
                <div class="section">
                ...
                <div class="section">
                    <label for="rbm_personalloan_name" class="half">First Name</label>
                    <input type="text" name="rbm_personalloan_name" class="half" id="rbm_personalloan_name" />
                </div>
                <div class="section">
                ...
                <div class="section">
                    ...
                    <input type="text" name="rbm_personalloan_last_name" class="half" id="rbm_personalloan_last_name" />
                </div>

                <div class="section" >
                    <label for="rbm_personalloan_loan_amount" class="half">Loan Amount</label>
                    <select name="rbm_personalloan_loan_amount" class="half" id="rbm_personalloan_loan_amount">
                    ...
                    <input type="hidden" id="rbm_personalloan_amount_pending" name="rbm_personalloan_amount_pending" />
                </div>
                <div class="section">
                    <label for="rbm_personalloan_zip" class="half">Zip Code</label>
                    <input type="text" name="rbm_personalloan_zip" class="quarter" id="rbm_personalloan_zip" />
                </div>
                <div class="notice">
                    Notice: There is no obligation to your quote.
                </div>
                <div class="far-right">
                    <label for="rbm_personalloan_terms" class="privacy_text">
                        I have read and agree to the 
                        <a href="javascript:void(0);" data-target="privacy" class="rbm_personalloan_overlay_open">privacy policy</a>
                        and the <a href="javascript:void(0);" data-target="conditions" class="rbm_personalloan_overlay_open">terms &amp; conditions</a>
                    </label>
            ...
            <div id="rbm_personalloan_footer" class="first_page_footer">
                <div id="rbm_personalloan_btn_filler"> </div>
                <input type="submit" id="rbm_personalloan_next_btn" class="single" value="GET MY CASH"/>
            </div>
        </form>
    </div>
