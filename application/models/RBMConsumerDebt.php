<?php
/**
 * The RBM ConsumerDebt API Wrapper Class File
 * 
 * @author Chris Koning <ckoning@realbrightmedia.com>
 */

/**
 * A Model Wrapper to Interact with the RBM API for consumer debt
 * 
 * @author Chris Koning <ckoning@realbrightmedia.com>
 */
class RBMConsumerDebt
{    //// MEMBERS
    /**
     ...
     * @static
     */    
    protected static $_service_url = 'https://api.rbmleads.com/consumerdebt/';
    
    /**
     * @var string The RBM API Key to use when interacting with the service
     */
    protected static $_api_key = '5948b396e996aa292c630b7f79123ed0';
     ...
     * customer
     */
    protected $_provider = 2;       // ActiveDebt
    ...
    {    // Create the member name string
        ...
        {    // Read protection
            case ($name == 'fieldMap'):
                throw new Zend_Exception("RBMConsumerDebt property {$name} is not readable");
                break;
    ...
    {   // Create the member name string
        ...
        {   // Handle the attributes set
            ...
            case ($name == 'fieldMap'):
                ...
                throw new Zend_Exception("RBMConsumerDebt property {$name} isn't writable");
                break;
            // Handle native properties
            case ($name == 'provider'):
            case ($name == 'test'):
